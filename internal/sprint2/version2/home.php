...
<main>
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <h2> About Us</h2>
                <div class="about-us"> Welcome to WGC Canteen! We opened since the beginning of the the century.
                    We strive to deliver quality food with reasonable price to our students.
                    Check out our menu to see all sorts of food and drinks available.</div><br>
            </div>
