...
if (isset($_POST['sorting_button'])) {
    ...
    /*displays all snacks*/
    if ($sort == 'all_snacks') {
        $all_snacks_query = "SELECT * 
            FROM products, statuses, categories
            WHERE products.category_id=categories.category_id
            AND products.category_id='SN'
            AND products.status_id=statuses.status_id";
        $result = mysqli_query($con, $all_snacks_query);

        /*shows most popular snacks first*/
...
<main>
    ...
    <form class="menu-fil" method='post' action='snacks.php'>
        <input class="button3" type="submit" value="Snacks">
    </form>
